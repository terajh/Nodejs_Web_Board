...
router.get('/board', (req, res, next) => {
    var AuthStatusui = auth.statusUI(req, res);
    db.query('SELECT * FROM userboard', (error, results) => {
        if (error) throw error;
...
router.post('/board_process', (req, res, next) => {
    ...
    db.query(`INSERT INTO userboard (username,description,created) VALUES('${req.user.nickname}', '${description}',NOW())`, (error, userboard) => {
